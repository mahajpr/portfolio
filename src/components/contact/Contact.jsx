...
const addressData = [
  {
    icon: faEnvelope,
    title: "Email",
    description: "mahavigneshwari0408@gmail.com",
    
  },
  {
    icon: faLocationDot,
    title: "Location",
    description: "Nagercoil, Tamil Nadu, India",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                Open to full-time opportunities as a Generative AI or Backend Developer. 
                Interested in building real-world AI systems, backend services, and scalable applications. 
